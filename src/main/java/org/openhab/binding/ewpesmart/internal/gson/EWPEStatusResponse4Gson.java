...
/**
 *
 * The EWPEStatusResponse4Gson class is used by Gson to hold values returned from
 * the Air Conditioner during requests for Status Updates to the
 * Air Conditioner.
 *
 * @author John Cunha - Initial contribution
 */
public class EWPEStatusResponse4Gson {
    ...
    public transient EWPEStatusResponsePack4Gson packJson = null;
}
