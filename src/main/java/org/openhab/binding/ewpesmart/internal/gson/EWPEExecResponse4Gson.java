...
/**
 *
 * The EWPEExecResponse4Gson class is used by Gson to hold values returned from
 * the Air Conditioner during requests for Execution of Commands to the
 * Air Conditioner.
 *
 * @author John Cunha - Initial contribution
 */
public class EWPEExecResponse4Gson {
    ...
    public transient EWPEExecResponsePack4Gson packJson = null;
