...
/**
 *
 * The EWPEScanResponse4Gson class is used by Gson to hold values returned by
 * the Air Conditioner during Scan Requests to the Air Conditioner.
 *
 * @author John Cunha - Initial contribution
 */
public class EWPEScanResponse4Gson {
    ...
    public transient EWPEScanReponsePack4Gson packJson = null;
}
